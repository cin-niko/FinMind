...
| `002-workflow/` | Draft phase 02 workflow suite for UI-runnable fundamental analysis, technical analysis, news digest, risk review, combined stock briefs, VN/US stock scope, evidence/citations, chart artifacts, and run inspection. |
