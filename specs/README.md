...
| FR-003 | `001-mvp-workflow-platform/spec.md` | Workflow tab and bounded workflow execution. |
...
| FR-019 | `system/runtime-config-security.md`, `001-mvp-workflow-platform/spec.md`, `002-data-operations/spec.md`, `003-evidence-backed-chat/spec.md` | Out-of-scope, unsupported, missing, stale, unavailable citation states. |
...
| FR-025 | `system/runtime-config-security.md`, `001-mvp-workflow-platform/spec.md` | Explicit V1 exclusions. |
