...
**Tests**: Include tests for changed behavior unless the spec or plan explicitly
documents a waiver. Documentation-only changes may skip automated tests.
...
- Tests MUST be written and FAIL before implementation unless waived in the spec or plan
